...
// Title: P05 Treasure Hunt - Button Class
...
public class Button implements Clickable {
  ...
  public boolean isMouseOver() {
	    ...
	    if (processing.mouseY > (this.HEIGHT + this.y) || processing.mouseY < this.y) {

	        return false;
	    }

	    else if (processing.mouseX > (this.WIDTH + this.x) || processing.mouseX < this.x) {
