...
// Title: P05 Treasure Hunt - Treasure Hunt Class
...
/**
* This class sets up the display, objects and contains all the game settings for the P05 project 
*/

public class TreasureHunt extends PApplet {

 // PImage object represents the background image
 private PImage backgroundImage;

 // Stores instances of objects in Clickable
 private ArrayList<Clickable> gameObjects;

 public static void main(String[] args) {
   /*
    * do not add any other statement to the main method The PApplet.main() method takes a String
    * input parameter which represents the name of your PApplet class
    */
 ...
 public void initGame() {
   ...
   RestartGameButton restart_button = new RestartGameButton(0, 0);
   this.gameObjects.add(restart_button);

   ScreenshotButton screenshot_button = new ScreenshotButton(140, 0);
   this.gameObjects.add(screenshot_button);
